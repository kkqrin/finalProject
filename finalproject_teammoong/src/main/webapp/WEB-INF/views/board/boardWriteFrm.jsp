				...
				<div class="content-board-wrap">
					<form action="/boardWrite.do" method="post">
						<table class="writeFrm-input-wrap">
							...
							<tr>
								<td colspan="4"><input type="text" name="boardName" class="mid-input" id="title"
										required></td>
							<tr>
							<tr>
							...
							<tr>
								...
								<td>
									<select class="select-custom" id="ui-id-1" name="accountBank">
							...
							<tr class="one-goods">
								<td colspan="4"><input type="text" id="goods-name" name="detailName"
										placeholder="상품명을 입력해 주세요" required></td>
							</tr>
							<tr class="one-goods">
								<td colspan="4"><input type="text" id="goods-price" name="detailPrice"
										placeholder="가격을 입력해 주세요" required></td>
							</tr>
							<tr class="one-goods">
								<td colspan="4"><input type="text" id="goods-count" name="detailCount"
										placeholder="재고를 입력해 주세요" required></td>
							</tr>
							<tr>
								<td colspan="4">
							...
							<tr>
								<td colspan="4"><input type="text" id="site-link" name="referenceLink"
										placeholder="공구 사이트 링크"></td>
							</tr>
							<tr>
							...
							<tr>
								<td colspan="4"><input type="text" id="etc-content" name="boardEtc"
										placeholder="문의사항 필요한 경우 작성해 주세요."></td>
							</tr>
